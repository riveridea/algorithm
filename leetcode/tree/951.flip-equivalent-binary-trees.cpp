...
public:
	...
	//let us try the recursionf firstly 
	//for root1 and root2 sharing the same root
	//if root1 and root2 are flip equvalent, then return true
	if(root1 == root2) return true; //this includes that both reach the last NULL leaf
